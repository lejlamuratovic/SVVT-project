...
import { HomePage } from "../code/page-objects/home-page";
import { createDriver, quitDriver } from "../code/config/driver-setup";
import { readFileSync } from "fs";
import * as path from "path";
import { RegistrationPage } from "../code/page-objects/registration-page";

const dataFilePath = path.resolve(__dirname, "../code/data/data.json");
